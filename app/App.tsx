...
export default function App() {
  ...
  return (
    <main className={`flex min-h-screen flex-col items-center justify-end transition-colors ${scheme === "light" ? "bg-slate-100" : "bg-slate-950"}`}>
      ...
      <button
        onClick={toggleTheme}
        className={`fixed top-4 right-6 z-30 p-3 rounded-lg shadow-md hover:shadow-lg transition-all border-2 border-[#B4995B] hover:border-[#D8CA90] ${scheme === "light" ? "bg-white" : "bg-slate-800"}`}
